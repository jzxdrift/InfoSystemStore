...
public class StaffHomeForm extends javax.swing.JFrame
{
            ...
            throws IOException
    {
        ...
        customerInfoForm = new CustomerInfoForm("staff", SALES_ID, this);
        inventoryInfoForm = new InventoryInfoForm("staff", this);
        transactionInfoForm = new TransactionInfoForm("staff", SALES_ID, this);
